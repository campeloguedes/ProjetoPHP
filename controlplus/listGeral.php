...
<script type='text/javascript'>
  ...
  function datagrid(like, order, limit) { 
	   $.ajax({ 
			 type: 'POST', 
			 url: '<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller', 
			 data: 'classe=GeralController&acao=datagrid&objeto=Geral&like='+like+'&order='+order+'&limit='+limit, 
			 beforeSend: function() { }, 
  ...
  var page		 = 1; 
  var defaultLike  = ""; 
  var defaultOrder = 'idgeral'; 
  var auxOrder = 'idgeral'; 
...
<div id='Content'> 
   ...
   <div class='category'>
		...
		<span class='sub_title'>Listagem De Geral</span> 
   </div>
 ...
 <br clear='all' /> 
   ...
   <table id='listReg' cellspacing='1' class='table'>
     <thead> 
        <tr> 
         ...
         <th class="order" id="th_idgeral" onclick="ordena('idgeral');">ID</th>
         <th class="order" id="th_email" onclick="ordena('email');">E-mail</th>
         <th class="order" id="th_telefone" onclick="ordena('telefone');">Telefone</th>
         <th class="order" id="th_endereco" onclick="ordena('endereco');">Endereço</th>
         <th class="order" id="th_bairro" onclick="ordena('bairro');">Bairro</th>
         <th class="order" id="th_cidade" onclick="ordena('cidade');">Cidade</th>
         <th class="order" id="th_e1titulo" onclick="ordena('e1titulo');">Etapa 1 (Título)</th>
         <th class="order" id="th_e2titulo" onclick="ordena('e2titulo');">Etapa 2 (Título)</th>
         <th class="order" id="th_e3titulo" onclick="ordena('e3titulo');">Etapa 3 (Título)</th>
         <th class="order" id="th_e4titulo" onclick="ordena('e4titulo');">Etapa 4 (Titulo)</th>
         <th>Ações</th>
        </tr> 
     </thead> 
         <tbody id='datagrid'> 
   ...
   <form id='formDel2' name='formDel2' action='<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller' method='post' accept-charset='utf-8'>
       <input type='hidden' name='classe' id='classe2' value='GeralController' />
       <input type='hidden' name='acao' id='acao2' value='excluirEmMassa' />
       <input type='hidden' name='objeto' id='objeto2' value='Geral' />
