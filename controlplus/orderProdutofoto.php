...
$('.btn2').show();
if(data==1){
window.location = '<?php echo $mainFolder ?>/controlplus/listProdutofoto';
}
if(data==2){
window.location = '<?php echo $mainFolder ?>/controlplus/listProdutofoto';
}
...
<?php $produtofotoController = new ProdutofotoController(); ?>
<?php $produtofotos = $produtofotoController->listarOrdenado('posicao asc'); ?>
...
<input type='hidden' name='tamanhoColecao' id='tamanhoColecao' value='<?php echo $produtofotos->count(); ?>' />
<div id='area_modulos'>
<?php $contM = 0; ?>
<?php foreach($produtofotos as $produtofoto){ 
$contM++;
?>
<div id='modulo_<?php echo $contM; ?>' class='camadaCompostaMini'>
<input type='hidden' id='idprodutofoto_<?php echo $contM; ?>' name='idprodutofoto_<?php echo $contM; ?>' value='<?php echo $produtofoto->idprodutofoto; ?>' />
<input type='hidden' name='posicao_<?php echo $contM; ?>' id='posicao_<?php echo $contM; ?>' value='<?php echo $contM; ?>' />
<b><?php echo $produtofoto->arquivo; ?></b>
</div>
<?php } ?>
</div><br/>
