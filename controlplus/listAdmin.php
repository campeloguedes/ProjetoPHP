...
<script type='text/javascript'>
  ...
  function datagrid(like, order, limit) { 
	   $.ajax({ 
			 ...
			 data: 'classe=AdminController&acao=datagrid&objeto=Admin&like='+like+'&order='+order+'&limit='+limit, 
			 beforeSend: function() { }, 
  ...
  var page		 = 1; 
  var defaultLike  = ""; 
  var defaultOrder = 'idadmin'; 
  var auxOrder = 'idadmin'; 
...
<div id='Content'> 
   ...
   <div class='category'>
		...
		<span class='sub_title'>Listagem de Admins</span> 
   </div>
 ...
 <br clear='all' /> 
   ...
   <table id='listReg' cellspacing='1' class='table'>
     <thead> 
        <tr> 
         ...
         <th class="order" id="th_idadmin" onclick="ordena('idadmin');">ID</th>
         <th class="order" id="th_perfil_idperfil" onclick="ordena('perfil_idperfil');">Perfil</th>
         <th class="order" id="th_nome" onclick="ordena('nome');">Nome</th>
         <th class="order" id="th_usuario" onclick="ordena('usuario');">Usuario</th>
   ...
   <form id='formDel2' name='formDel2' action='<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller' method='post' accept-charset='utf-8'>
       <input type='hidden' name='classe' id='classe2' value='AdminController' />
       <input type='hidden' name='acao' id='acao2' value='excluirEmMassa' />
       <input type='hidden' name='objeto' id='objeto2' value='Admin' />
