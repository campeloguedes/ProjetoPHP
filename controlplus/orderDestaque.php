...
$('.btn2').show();
if(data==1){
window.location = '<?php echo $mainFolder ?>/controlplus/listDestaque';
}
if(data==2){
window.location = '<?php echo $mainFolder ?>/controlplus/listDestaque';
}
...
<?php $destaques = $destaqueController->listarOrdenado('posicao asc'); ?>
...
<input type='hidden' name='tamanhoColecao' id='tamanhoColecao' value='<?php echo $destaques->count(); ?>' />
<div id='area_modulos'>
<?php $contM = 0; ?>
...
<input type='hidden' id='iddestaque_<?php echo $contM; ?>' name='iddestaque_<?php echo $contM; ?>' value='<?php echo $destaque->iddestaque; ?>' />
