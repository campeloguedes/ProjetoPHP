...
<script type='text/javascript'>
  ...
  function datagrid(like, order, limit) { 
	   $.ajax({ 
			 type: 'POST', 
			 url: '<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller', 
			 data: 'classe=ProdutoController&acao=datagrid&objeto=Produto&like='+like+'&order='+order+'&limit='+limit, 
			 beforeSend: function() { }, 
  ...
  var page		 = 1; 
  var defaultLike  = ""; 
  var defaultOrder = 'idproduto'; 
  var auxOrder = 'idproduto'; 
...
<div id='Content'> 
   ...
   <div class='category'>
		...
		<span class='sub_title'>Listagem De Produtos</span> 
   </div>
 ...
 <br clear='all' /> 
   ...
   <table id='listReg' cellspacing='1' class='table'>
     <thead> 
        <tr> 
         ...
         <th class="order" id="th_idproduto" onclick="ordena('idproduto');">ID</th>
         <th class="order" id="th_anunciante_idanunciante" onclick="ordena('anunciante_idanunciante');">Anunciante</th>
         <th class="order" id="th_categoria_idcategoria" onclick="ordena('categoria_idcategoria');">Categoria</th>
         <th class="order" id="th_subcategoria_idsubcategoria" onclick="ordena('subcategoria_idsubcategoria');">Subcategoria</th>
         <th class="order" id="th_titulo" onclick="ordena('titulo');">Título</th>
         <th class="order" id="th_preco" onclick="ordena('preco');">Preço</th>
         <th class="order" id="th_destaque" onclick="ordena('destaque');">Destaque Na Home?</th>
         <th>Ações</th>
        </tr> 
     </thead> 
         <tbody id='datagrid'> 
   ...
   <form id='formDel2' name='formDel2' action='<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller' method='post' accept-charset='utf-8'>
       <input type='hidden' name='classe' id='classe2' value='ProdutoController' />
       <input type='hidden' name='acao' id='acao2' value='excluirEmMassa' />
       <input type='hidden' name='objeto' id='objeto2' value='Produto' />
