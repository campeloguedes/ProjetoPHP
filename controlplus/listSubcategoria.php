...
<script type='text/javascript'>
  ...
  function datagrid(like, order, limit) { 
	   $.ajax({ 
			 type: 'POST', 
			 url: '<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller', 
			 data: 'classe=SubcategoriaController&acao=datagrid&objeto=Subcategoria&like='+like+'&order='+order+'&limit='+limit, 
			 beforeSend: function() { }, 
  ...
  var page		 = 1; 
  var defaultLike  = ""; 
  var defaultOrder = 'idsubcategoria'; 
  var auxOrder = 'idsubcategoria'; 
...
<div id='Content'> 
   ...
   <div class='category'>
		...
		<span class='sub_title'>Listagem De Subcategorias</span> 
   </div>
 ...
 <br clear='all' /> 
   ...
   <table id='listReg' cellspacing='1' class='table'>
     <thead> 
        <tr> 
         ...
         <th class="order" id="th_idsubcategoria" onclick="ordena('idsubcategoria');">ID</th>
         <th class="order" id="th_categoria_idcategoria" onclick="ordena('categoria_idcategoria');">Categoria</th>
         <th class="order" id="th_nome" onclick="ordena('nome');">Nom</th>
         <th>Ações</th>
        </tr> 
     </thead> 
         <tbody id='datagrid'> 
   ...
   <form id='formDel2' name='formDel2' action='<?php echo $mainFolder; ?>/mediaplus/controller/mpcontroller' method='post' accept-charset='utf-8'>
       <input type='hidden' name='classe' id='classe2' value='SubcategoriaController' />
       <input type='hidden' name='acao' id='acao2' value='excluirEmMassa' />
       <input type='hidden' name='objeto' id='objeto2' value='Subcategoria' />
